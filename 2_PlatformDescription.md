...
This page provides description of the variables included in the Platform Description metadata. Use this to guide completion of the [Platform Description metadata template](templates). 
