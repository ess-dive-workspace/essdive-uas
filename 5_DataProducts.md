...
Note that this list is intended to show examples for each data Level, and is not exhaustive of all possible products or file formats. csv file types should follow the [ESS-DIVE Reporting Format for Comma-separated Values File Structure](https://github.com/ess-dive-workspace/essdive-csv-structure).
