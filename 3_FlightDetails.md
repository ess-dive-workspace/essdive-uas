...
This page provides description of the variables included in the Flight Detail metadata. Use this to guide completion of the [Flight Detail metadata template](templates). 
