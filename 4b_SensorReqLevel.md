...
This table indicates the requirement level of each [Sensor Specification metadata variable](4a_SensorSpecs.md) for each sensor type. 
...
Use this to guide completion of the [Sensor Specification metadata template](templates) for each sensor type. 
