...
This page provides description of the variables included in the Campaign Summary metadata. Use this to guide completion of the [Campaign Summary metadata template](templates). 
